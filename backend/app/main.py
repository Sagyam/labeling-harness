...
def create_app() -> FastAPI:
    ...
    from app.api import episodes, export, health, ingest, queue, segments, tasks, translit

    for module in (health, ingest, queue, tasks, segments, translit, episodes, export):
