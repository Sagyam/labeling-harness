...
Turns are automatic and cannot be trusted (D100), neither for which speaker said a word nor for
where a turn changes: changes in pace, excitement and loudness read as a change of speaker. They
colour the editors and are never a reference, and voice ids are not a speaker count.
